...
# Expose port สำหรับ Streamlit (8501 local, 8080 สำหรับ Fly.io)
EXPOSE 8501 8080

# รัน Streamlit — ใช้ PORT จาก env ถ้ามี (Fly.io ใช้ 8080)
CMD ["sh", "-c", "exec streamlit run gui_app.py --server.port=${PORT:-8501} --server.address=0.0.0.0"]
